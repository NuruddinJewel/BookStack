...
import { FiDollarSign, FiCalendar, FiFileText, FiHash, FiUser } from 'react-icons/fi';
        ...
        <div className="space-y-6">
            ...
            <div>
                ...
                <p className="text-sm text-[var(--ink-3)] mt-1 m-0">
                    View and audit all platform revenues, publishing fees, and ebook purchases.
                </p>
            </div>
                        ...
                        <table className="w-full text-left border-collapse">
                            <thead>
                                <tr className="border-b border-[var(--border)] bg-[rgba(0,0,0,0.02)]">
                                    ...
                                    <th className="p-4 text-xs font-semibold uppercase tracking-wider text-[var(--ink-2)]">
                                        <div className="flex items-center gap-1"><FiUser /> Account Email</div>
                                    </th>
                                    <th className="p-4 text-xs font-semibold uppercase tracking-wider text-[var(--ink-2)]">
                            ...
                            <tbody className="divide-y divide-[var(--border)]">
                                {transactions.map((tx) => (
                                    <tr key={tx._id} className="hover:bg-[rgba(0,0,0,0.01)] transition-colors">
                                        ...
                                        {/* Type (Publishing Fee / Purchase) */}
                                        <td className="p-4">
                                            <span className={`inline-flex px-2.5 py-1 rounded-full text-[10px] font-bold uppercase tracking-wider border ${tx.type === 'publishing fee'
