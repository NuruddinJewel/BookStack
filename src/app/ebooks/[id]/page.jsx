                        ...
                        <div className="space-y-4 text-[var(--ink-3)] leading-relaxed">
                            ...
                            <p>
                                {book.description ? (
                                    ...
                                    <>
                                        Dive into the captivating world of <strong>{book.title}</strong> by {book.author || "Unknown"}.{" "}
                                        This masterfully crafted piece in the {book.category || "General"} genre will take you on an unforgettable journey.
                                    </>
                                )}
                            </p>
                        </div>
